...
<template>
        ...
        <div class="card">
            <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
                ...
                <p class="font-work_sans pr-12">
                    Designed some empty state screens in kawaii style for the
                    popular sheepify app.Tailwind lets you conditionally apply
                    utility classes in different states using variant modifiers.
                    For example, use hover:gap-6 to only apply the gap-6 utility
                </p>
    ...
    <div class="banner-1" id="testimonial">
        <div class="space-y-4 grid place-items-center mt-5">
            ...
            <p
                class="font-work_sans text-gray-600 font-semibold leading-relaxed"
            >
                        ...
                        >
                            <p>
                                ...
                                <strong class="text-gray-900 font-medium"
                                    >Slack</strong
                                >
                                grows rapidly, using Stripe helps them scale
                                payments easily &mdash; supporting everything
                                from getting paid by users around the world to
    ...
    <div class="banner-1 flex h-full items-center">
        <div class="w-7/12 p-12">
            <h2
                class="text-gray-700 md:text-6xl text-2xl font-Eczar mb-5 font-bold"
            >

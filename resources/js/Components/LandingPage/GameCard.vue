...
const resetTilt = () => {
  tiltStyles.value.transform = 'perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)'
}
</script>
  ...
  >
    <div class="relative h-60 overflow-hidden">
      ...
      <div class="absolute top-0 right-0 m-4">
        <span class="bg-purple-600 text-white text-xs px-2 py-1 rounded-full">{{ game.genre }}</span>
      </div>
    </div>
    ...
    <div class="p-6">
      ...
      <button class="w-full py-2 rounded-lg bg-gradient-to-r from-purple-500 to-cyan-400 text-white font-bold hover:shadow-lg hover:from-purple-600 hover:to-cyan-500 transition-all">
        Play Now
      </button>
    </div>
  </div>
